...
- En la propertie general de Spring Boot, deberás cambiar el environment de prod a **dev**.
```
...
```
Se te adjunta una ímagen para que se te haga más sencillo de comprender como debe de quedar dicho Dockerfile:
