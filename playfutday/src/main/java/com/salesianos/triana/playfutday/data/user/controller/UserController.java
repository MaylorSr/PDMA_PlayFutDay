...
public class UserController {
    ...
    /**
     * Si quitamos el @AuthenticationPrincipal, al borrar al usuario en este caso desde el punto del administrador, si intenta
     * realizar otra petición como GETALLPOST, deberá voler a logearse, por tanto es necesaria que sequede con el token del usuario
     * admin en este caso.
     */
    public ResponseEntity<?> deleteUser(@Parameter(name = "idU", description = "Id del usuario a eliminar")
                                        @PathVariable UUID idU, @AuthenticationPrincipal User user) {
